...
var meaning = function (dictBounded) {
    return function (b) {
        return function (t) {
            ...
            return valueOf()(FRP_Behavior.sample(b)(once(t)(Control_Category.identity(Control_Category.categoryFn))));
        };
    };
};
    ...
    return function (v) {
        var split = function (p$prime) {
            return function (v1) {
                ...
                throw new Error("Failed pattern match at FRP.Event.Semantic (line 193, column 30 - line 195, column 39): " + [ v2.constructor.name ]);
            };
        };
        var go = function (v1) {
            return {
...
var compactableSemantic = new Data_Compactable.Compactable(Data_Filterable.filterMap(filterableSemantic)(Control_Category.identity(Control_Category.categoryFn)), Data_Filterable.partitionMap(filterableSemantic)(Control_Category.identity(Control_Category.categoryFn)));
...
var isEventSemantic = function (dictBounded) {
    return new FRP_Event_Class.IsEvent(function () {
        ...
        var go = function (v1) {
            ...
            throw new Error("Failed pattern match at FRP.Event.Semantic (line 215, column 5 - line 215, column 17): " + [ v1.constructor.name ]);
        };
        return go(v);
    }, function (v) {
        return function (v1) {
...
module.exports = {
    ...
    compactableSemantic: compactableSemantic,
