...
var debug = function (dictShow) {
    return function (evt) {
        var f = function (v) {
            return Control_Apply.applySecond(Effect.applyEffect)(Effect_Class_Console.logShow(Effect_Class.monadEffectEffect)(dictShow)(v))(Control_Applicative.pure(Effect.applicativeEffect)(v));
        };
                ...
                return FRP_Event.subscribe(evt)(function (v1) {
                    return function __do() {
                        ...
                        (function () {
                            ...
                            throw new Error("Failed pattern match at FRP.Event.Extra (line 44, column 9 - line 46, column 33): " + [ tf.constructor.name ]);
                        })();
