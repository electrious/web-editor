...
function toJSRoofPlate(r) {
    return {
        ...
        lead_id: r.leadId,
        // eslint-disable-next-line @typescript-eslint/camelcase
        border_points: r.borderPoints.map(function (v) {
...
exports.toJSRoofPlate = toJSRoofPlate;
/**
...
function isRoofPlate(r) {
    return r.normal !== undefined;
}
...
exports.toJSRoofOperation = toJSRoofOperation;
