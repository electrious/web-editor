...
var OBJLoader2_1 = require("three/examples/jsm/loaders/OBJLoader2");
...
function meshPath(dataServerUrl, leadId) {
 ...
 * @param {number} leadId
 */
function loadHouse(dataServerUrl, leadId) {
    var objLoader = new OBJLoader2_1.OBJLoader2();
    var mtlLoader = new MTLLoader_1.MTLLoader();
    var path = meshPath(dataServerUrl, leadId);
